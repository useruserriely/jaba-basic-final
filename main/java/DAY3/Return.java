...
public class Return {
    ...
    public static double circleArea(int radius) { // void는 메서드나 함수의 반환 타입이 없음을 나타내는 자바의 키워드
//        System.out.println(radius * radius * 3.14);
    ...
    public static void main(String[] args) {
        ...
        // 함수끼리는 서로 호출하고 호출당하는 관계
        // 함수가 자신을 호출한 쪽으로 값을 전하는 것이 출력(리턴값)
        // 함수의 결과값을 이용해 2차 작업을 하기 위해서는 함수의 전달값을 받아서 사용할 수 있어야 한다.
        // 함수의 전달값은 return 값을 이용해 전달한다.
    }
}
